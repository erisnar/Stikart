...
const raceRoutes = [
    ...
    },
    {
        id: 'hodelyktlopet',
        name: 'Hodelyktløpet',
        files: ['race-calendar/ØstmarkaTrailChallenge/Hodelyktløpet_2025.gpx'],
        gpxUpdated: '2026-07-22',
        gpxYear: 2025,
        color: '#006d77',
        url: 'https://www.ostmarkatrail.no/hodelyktlopet/',
        useCalculatedStats: true,
        category: 'short-trail',
        date: '2026-11-19',
    ...
    },
    {
        ...
        files: [
            'race-calendar/OsloTrailChallenge/OTC_200K_p01_v04.gpx',
        ],
        gpxUpdated: '2026-08-31',
        color: '#d35400',
        url: 'https://langtoglenge.org/en/events_en/otc_en.html',
        useCalculatedStats: true,
        category: '100-miles-plus',
        date: '2026-09-20',
        description: 'Oslo Trail Challenge er et ultraløp gjennom skogsområdene Nordmarka, Lillomarka og Romeriksåsen nord for Oslo.',
    },
    {
        id: 'oslo-trail-challenge-100k',
        name: 'Oslo Trail Challenge 100K',
        files: ['race-calendar/OsloTrailChallenge/OTC_100K_v03.gpx'],
        gpxUpdated: '2026-08-31',
        color: '#dc7633',
        url: 'https://langtoglenge.org/en/events_en/otc_en.html',
        useCalculatedStats: true,
    ...
    },
    {
        ...
        files: ['race-calendar/OsloTrailChallenge/OTC_55K_v02.gpx'],
        gpxUpdated: '2026-08-31',
        color: '#f0b27a',
        url: 'https://langtoglenge.org/en/events_en/otc_en.html',
        useCalculatedStats: true,
    ...
    {
        id: 'oslo-trail-challenge-21k',
        name: 'Oslo Trail Challenge 21k',
        files: ['race-calendar/OsloTrailChallenge/OTC_21k_v03.gpx'],
        gpxUpdated: '2026-08-31',
        color: '#f0b27a',
        url: 'https://langtoglenge.org/en/events_en/otc_en.html',
        useCalculatedStats: true,
